...
function DeleteMediaComments(comment_id, token) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const result = yield DeleteComment(comment_id, token);
            return result;
        }
        catch (error) {
...
exports.default = DeleteMediaComments;
//# sourceMappingURL=DeleteMediaComment.js.map