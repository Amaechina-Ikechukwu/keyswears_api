...
function GetInstagramBusinessAccountId(uuid) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // const appId = process.env.CLIENT_ID;
            // const appSecret = process.env.CLIENT_SECRET;
            const { pageid, access_token } = yield GetPageInfo(uuid);
            const url = `https://graph.facebook.com/v18.0/${pageid}?fields=instagram_business_account&access_token=${access_token}`;
            ...
            console.error("Error while fetching IG business account id token:", error.message);
