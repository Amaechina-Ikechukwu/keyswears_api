...
function HideComment(comment_id, token) {
...
function HideMediaComments(comment_id, token) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const result = yield HideComment(comment_id, token);
            return result;
        }
        catch (error) {
...
exports.default = HideMediaComments;
//# sourceMappingURL=HideMediaComment.js.map