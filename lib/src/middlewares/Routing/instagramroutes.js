...
router.get("/registeruser", ValidatedUUIDHeader_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { uuid } = yield (0, QueryUserDetails_1.default)(req.uuid);
        yield (0, GetInstagramBusinessAccountId_1.default)(uuid);
        res.status(200).json({ message: "done" });
    }
    catch (error) {
        res.status(500).json({
...
router.get("/accountinsight", ValidatedUUIDHeader_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { ig_token } = yield (0, QueryUserDetails_1.default)(req.uuid);
        const data = yield (0, GetAccountInsight_1.default)(user_id, ig_token);
        res.status(200).json(data);
    }
    catch (error) {
        res.status(500).json({
