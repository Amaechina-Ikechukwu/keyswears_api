...
const HideMediaComment_1 = __importDefault(require("../../actions/Instagram/HideMediaComment"));
const DeleteMediaComment_1 = __importDefault(require("../../actions/Instagram/DeleteMediaComment"));
const GetCommentReplies_1 = __importDefault(require("../../actions/Instagram/GetCommentReplies"));
const ReplyComment_1 = __importDefault(require("../../actions/Instagram/ReplyComment"));
const UnHideMediaComment_1 = __importDefault(require("../../actions/Instagram/UnHideMediaComment"));
...
router.get("/mediacommentsreply", ValidatedUUIDHeader_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { comment_id } = req.query;
        const { ig_token } = yield (0, QueryUserDetails_1.default)(req.uuid);
        const data = yield (0, GetCommentReplies_1.default)(comment_id, ig_token);
        res.status(200).json(data);
    }
    catch (error) {
        res.status(500).json({
...
router.post("/mediareplycomment", ValidatedUUIDHeader_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { comment_id, message } = req.body;
        const { ig_token } = yield (0, QueryUserDetails_1.default)(req.uuid);
        const data = yield (0, ReplyComment_1.default)(comment_id, message, ig_token);
        res.status(200).json(data);
    }
    catch (error) {
        res.status(500).json({
...
router.get("/mediahidecomments", ValidatedUUIDHeader_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { comment_id } = req.query;
        const { ig_token } = yield (0, QueryUserDetails_1.default)(req.uuid);
        const data = yield (0, HideMediaComment_1.default)(comment_id, ig_token);
        res.status(200).json(data);
    }
    catch (error) {
        res.status(500).json({
...
router.get("/mediaunhidecomments", ValidatedUUIDHeader_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { comment_id } = req.query;
        const { ig_token } = yield (0, QueryUserDetails_1.default)(req.uuid);
        const data = yield (0, UnHideMediaComment_1.default)(comment_id, ig_token);
        res.status(200).json(data);
    }
    catch (error) {
        res.status(500).json({
...
router.get("/mediadeletecomments", ValidatedUUIDHeader_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { comment_id } = req.query;
        const { ig_token } = yield (0, QueryUserDetails_1.default)(req.uuid);
        const data = yield (0, DeleteMediaComment_1.default)(comment_id, ig_token);
        res.status(200).json(data);
    }
    catch (error) {
        res.status(500).json({
